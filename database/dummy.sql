...
VALUES (@g_sby, 'Gudang Cabang Surabaya', 'Jl. Raya Darmo No. 12, Surabaya', 'active', NULL);
SET @adm_sby = UUID();
INSERT INTO admin (id_admin, nama_admin, username_admin, password_admin, email_admin, id_gudang)
VALUES (@adm_sby, 'Budi Santoso', 'admin1', @pass, 'budi.santoso@gudangsby.com', @g_sby);
...
-- GUDANG SIDOARJO
SET @g_sda = UUID();
INSERT INTO gudang (id_gudang, nama_gudang, lokasi_gudang, status_gudang, expired_date_gudang) VALUES (@g_sda, 'Gudang Cabang Sidoarjo', 'Jl. Wahid Hasyim No. 88, Sidoarjo', 'active', NULL);
SET @adm_sda = UUID();
INSERT INTO admin (id_admin, nama_admin, username_admin, password_admin, email_admin, id_gudang) VALUES (@adm_sda, 'Sutrisno Wijaya', 'admin2', @pass, 'sutrisno.wijaya@gudangsda.com', @g_sda);
...
-- GUDANG MALANG
SET @g_mlg = UUID();
INSERT INTO gudang (id_gudang, nama_gudang, lokasi_gudang, status_gudang, expired_date_gudang) VALUES (@g_mlg, 'Gudang Cabang Malang', 'Jl. Soekarno Hatta No. 45, Malang', 'trial', DATE_ADD(NOW(), INTERVAL 7 DAY));
SET @adm_mlg = UUID();
INSERT INTO admin (id_admin, nama_admin, username_admin, password_admin, email_admin, id_gudang) VALUES (@adm_mlg, 'Dewi Lestari', 'admin3', @pass, 'dewi.lestari@gudangmlg.com', @g_mlg);
...
SET @m_supply = UUID();
SET @m_buy = UUID();
INSERT INTO mitra (id_mitra, nama_mitra, username_mitra, password_mitra, email_mitra) 
VALUES 
(@m_supply, 'PT. Indofood Sukses Makmur', 'indofood', @pass, 'supply@indofood.com'),
(@m_buy, 'Toko Kelontong Madura', 'madura_jaya', @pass, 'madura@kelontong.com');

-- TRANSAKSI SURABAYA
SET @t1 = UUID();
INSERT INTO transaksi VALUES (@t1, 'supply', DATE_SUB(NOW(), INTERVAL 3 MONTH), 2500000, @m_supply, @adm_sby, @g_sby);
SET @dt1 = UUID();
...
SET @t2 = UUID();
INSERT INTO transaksi VALUES (@t2, 'supply', DATE_SUB(NOW(), INTERVAL 1 MONTH), 3750000, @m_supply, @adm_sby, @g_sby);
SET @dt2 = UUID();
...
SET @t3 = UUID();
INSERT INTO transaksi VALUES (@t3, 'supply', NOW(), 3120000, @m_supply, @adm_sby, @g_sby);
SET @dt3 = UUID();
SET @dt4 = UUID();
...
SET @t4 = UUID();
INSERT INTO transaksi VALUES (@t4, 'supply', DATE_SUB(NOW(), INTERVAL 2 WEEK), 1900000, @m_supply, @adm_sby, @g_sby);
SET @dt5 = UUID();
SET @dt6 = UUID();
...
SET @t5 = UUID();
INSERT INTO transaksi VALUES (@t5, 'supply', NOW(), 6000000, @m_supply, @adm_sby, @g_sby);
SET @dt7 = UUID();
...
SET @t6 = UUID();
INSERT INTO transaksi VALUES (@t6, 'supply', DATE_SUB(NOW(), INTERVAL 1 WEEK), 6600000, @m_supply, @adm_sby, @g_sby);
SET @dt8 = UUID();
SET @dt9 = UUID();
...
SET @t7 = UUID();
INSERT INTO transaksi VALUES (@t7, 'supply', NOW(), 5200000, @m_supply, @adm_sby, @g_sby);
SET @dt10 = UUID();
SET @dt11 = UUID();
...
-- TRANSAKSI SIDOARJO
SET @t8 = UUID();
INSERT INTO transaksi VALUES (@t8, 'supply', DATE_SUB(NOW(), INTERVAL 2 MONTH), 4800000, @m_supply, @adm_sda, @g_sda);
SET @dt12 = UUID();
...
SET @t9 = UUID();
INSERT INTO transaksi VALUES (@t9, 'supply', DATE_SUB(NOW(), INTERVAL 1 MONTH), 10250000, @m_supply, @adm_sda, @g_sda);
SET @dt13 = UUID();
SET @dt14 = UUID();
...
SET @t10 = UUID();
INSERT INTO transaksi VALUES (@t10, 'supply', NOW(), 6950000, @m_supply, @adm_sda, @g_sda);
SET @dt15 = UUID();
SET @dt16 = UUID();
...
SET @t11 = UUID();
INSERT INTO transaksi VALUES (@t11, 'supply', DATE_SUB(NOW(), INTERVAL 3 WEEK), 18000000, @m_supply, @adm_sda, @g_sda);
SET @dt17 = UUID();
...
SET @t12 = UUID();
INSERT INTO transaksi VALUES (@t12, 'supply', DATE_SUB(NOW(), INTERVAL 1 WEEK), 19800000, @m_supply, @adm_sda, @g_sda);
SET @dt18 = UUID();
SET @dt19 = UUID();
...
SET @t13 = UUID();
INSERT INTO transaksi VALUES (@t13, 'supply', NOW(), 8700000, @m_supply, @adm_sda, @g_sda);
SET @dt20 = UUID();
SET @dt21 = UUID();
...
SET @t14 = UUID();
INSERT INTO transaksi VALUES (@t14, 'supply', DATE_SUB(NOW(), INTERVAL 2 DAY), 4700000, @m_supply, @adm_sda, @g_sda);
SET @dt22 = UUID();
SET @dt23 = UUID();
...
-- TRANSAKSI MALANG
SET @t15 = UUID();
INSERT INTO transaksi VALUES (@t15, 'supply', DATE_SUB(NOW(), INTERVAL 5 DAY), 18000000, @m_supply, @adm_mlg, @g_mlg);
SET @dt24 = UUID();
...
SET @t16 = UUID();
INSERT INTO transaksi VALUES (@t16, 'supply', DATE_SUB(NOW(), INTERVAL 3 DAY), 24000000, @m_supply, @adm_mlg, @g_mlg);
SET @dt25 = UUID();
SET @dt26 = UUID();
...
SET @t17 = UUID();
INSERT INTO transaksi VALUES (@t17, 'supply', DATE_SUB(NOW(), INTERVAL 1 DAY), 24100000, @m_supply, @adm_mlg, @g_mlg);
SET @dt27 = UUID();
SET @dt28 = UUID();
...
SET @t18 = UUID();
INSERT INTO transaksi VALUES (@t18, 'supply', NOW(), 23600000, @m_supply, @adm_mlg, @g_mlg);
SET @dt29 = UUID();
SET @dt30 = UUID();
...
SET @t19 = UUID();
INSERT INTO transaksi VALUES (@t19, 'supply', NOW(), 22000000, @m_supply, @adm_mlg, @g_mlg);
SET @dt31 = UUID();
SET @dt32 = UUID();
