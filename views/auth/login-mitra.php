            ...
            <div class="lg:w-1/2 p-12">
                <div class="max-w-md mx-auto">
                    <div class="text-center mb-8">
                        ...
                        <p class="text-gray-600">Sign in to your partner account</p>
                    </div>
                    ...
                    <div class="mt-6 space-y-3">
                        <div class="text-center">
                            <p class="text-sm text-gray-600">
                                ...
                                <a href="/signup/mitra" class="font-semibold" style="color: #877acc;" onmouseover="this.style.opacity='0.8'" onmouseout="this.style.opacity='1'">Sign up</a>
                            </p>
                        </div>
                        <div class="text-center">
                            <p class="text-sm text-gray-600">
