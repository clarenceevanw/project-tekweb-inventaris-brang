...
<div class="p-6 space-y-6">
    ...
    <div>
        <h1 class="text-3xl font-bold text-theme-primary">Daftar Ruangan</h1>
        <p class="text-theme-primary mt-1">Kelola ruangan penyimpanan di gudang</p>
    </div>
            ...
            <table class="table-theme min-w-full divide-y divide-gray-200">
                ...
                <tbody class="bg-white divide-y divide-gray-200" id="tableBody">
                    ...
                    <?php else: ?>
                        ...
                        <tr class="hover:bg-gray-50 transition-colors duration-150" data-nama="<?= strtolower($row['nama_ruangan']) ?>">
...
function applyFilter() {
    ...
    $('#noDataRow').remove();
    if (visibleCount === 0) {
        $('#tableBody').append('<tr id="noDataRow"><td colspan="2" class="px-6 py-4 text-center text-gray-500">Tidak ada ruangan yang sesuai.</td></tr>');
    }
}
