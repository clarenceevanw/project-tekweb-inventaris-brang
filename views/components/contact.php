<style>
    ...
    .neuro-icon {
        ...
        box-shadow:
            ...
            -3px -3px 6px rgba(71, 93, 104, 0.5);
    }

    .neuro-icon:hover {
        box-shadow:
            2px 2px 4px rgba(0, 0, 0, 0.2),
            -2px -2px 4px rgba(71, 93, 104, 0.4);
    }
            ...
            <div class="flex flex-col gap-3 md:gap-6">
                ...
                <a href="https://maps.google.com/?q=Jl.+Siwalankerto+No.121-131,+Surabaya"
                    ...
                    <div class="flex items-start gap-3">
                        <div class="w-9 h-9 md:w-10 md:h-10 rounded-xl md:rounded-2xl
                            ...
                            <svg class="w-5 h-5 md:w-6 md:h-6 text-[#FBEFDF] drop-shadow-lg" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" />
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 11a3 3 0 11-6 0 3 3 0 016 0z" />
                            </svg>
                        </div>
                        <div class="flex-1 min-w-0">
                            <h3 class="text-base md:text-lg font-semibold mb-1 md:mb-2 drop-shadow" style="color: #FBEFDF;">Alamat</h3>
                            <p class="leading-relaxed text-sm md:text-base" style="color: #FBEFDF; opacity: 0.8;">Jl. Siwalankerto No.121-131, Surabaya, Jawa Timur</p>
                        </div>
                        <svg class="w-4 h-4 md:w-5 md:h-5 group-hover:translate-x-1 transition-all duration-300 drop-shadow flex-shrink-0" style="color: #FBEFDF; opacity: 0.6;" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <a href="mailto:info@gudangpintar.com"
                    ...
                    <div class="flex items-start gap-3">
                        ...
                        <div class="flex-1 min-w-0">
                            <h3 class="text-base md:text-lg font-semibold mb-1 md:mb-2 drop-shadow" style="color: #FBEFDF;">Email</h3>
                            <p class="text-sm md:text-base break-all" style="color: #FBEFDF; opacity: 0.8;">info@gudangpintar.com</p>
                        </div>
                        <svg class="w-4 h-4 md:w-5 md:h-5 group-hover:translate-x-1 transition-all duration-300 drop-shadow flex-shrink-0" style="color: #FBEFDF; opacity: 0.6;" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7" />
                        </svg>
                ...
                <a href="https://wa.me/628123456789"
                    ...
                    <div class="flex items-start gap-3">
                        <div class="w-9 h-9 md:w-10 md:h-10 rounded-xl md:rounded-2xl
                                    flex items-center justify-center flex-shrink-0
                                    neuro-icon transition-all duration-500 group-hover:rotate-6">
                            <svg class="w-5 h-5 md:w-6 md:h-6 text-[#FBEFDF] drop-shadow-lg" fill="currentColor" viewBox="0 0 24 24">
                        ...
                        <div class="flex-1 min-w-0">
                            <h3 class="text-base md:text-lg font-semibold mb-1 md:mb-2 drop-shadow" style="color: #FBEFDF;">WhatsApp</h3>
                            <p class="text-sm md:text-base" style="color: #FBEFDF; opacity: 0.8;">+62 812-3456-7890</p>
                        </div>
                        <svg class="w-4 h-4 md:w-5 md:h-5 group-hover:translate-x-1 transition-all duration-300 drop-shadow flex-shrink-0" style="color: #FBEFDF; opacity: 0.6;" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7" />
                        </svg>
                    ...
                    <div class="flex items-start gap-3">
                        ...
                        <div class="flex-1 min-w-0">
                            <div class="flex items-center justify-between mb-1 md:mb-2 gap-2">
                                <h3 class="text-base md:text-lg font-semibold drop-shadow" style="color: #FBEFDF;">Jam Operasional</h3>
                            ...
                            <p class="mb-0.5 md:mb-1 text-sm md:text-base" style="color: #FBEFDF; opacity: 0.8;">Senin - Jumat: 09:00 - 17:00</p>
                            <p class="text-sm md:text-base" style="color: #FBEFDF; opacity: 0.8;">Sabtu: 09:00 - 13:00</p>
                        </div>
                    </div>
                </div>
