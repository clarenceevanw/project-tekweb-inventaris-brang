    ...
    <div class="bg-white rounded-xl shadow-lg border border-gray-100 overflow-hidden">
        ...
        <div class="p-8 border-b border-gray-100 bg-gray-50/50">
            <div class="flex items-start justify-between gap-4">
                <div class="flex items-start gap-4">
                    <div class="bg-theme-light p-3 rounded-xl flex-shrink-0">
        ...
        <div class="p-8">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div class="md:col-span-2 bg-gray-50 rounded-lg p-4 border border-gray-100 text-center hover:border-theme-primary transition-colors flex flex-col justify-center">
                ...
                <div class="bg-gray-50 rounded-lg p-4 border border-gray-100 text-center hover:border-theme-primary transition-colors flex flex-col justify-center">
        ...
        <div class="bg-gray-50 px-8 py-5 border-t border-gray-200 flex flex-col sm:flex-row gap-3">
            <a href="/admin/scan" class="inline-flex justify-center items-center px-4 py-2.5 flex-1 btn-theme-primary shadow-sm">
