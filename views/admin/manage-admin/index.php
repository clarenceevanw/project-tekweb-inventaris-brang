                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="flex items-center">
                                    <div class="flex-shrink-0 h-10 w-10">
                                        <div class="h-10 w-10 rounded-full bg-[var(--theme-secondary-lighter)] flex items-center justify-center">
                                            <svg class="h-6 w-6 text-theme-secondary" fill="none" stroke="currentColor" viewBox="0 0 24 24">
